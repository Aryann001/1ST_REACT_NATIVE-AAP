...
import { clearErrors, resetPassword } from "../redux/actions/action";
...
const ResetPassword = () => {
  ...
  const registerHandler = async () => {
    await dispatch(resetPassword(otp, newPassword, confirmPassword));
  };
      ...
      <View style={style.loginContainer}>
        <View style={style.loginHeadingDiv}>
          <View style={style.loginHeadingDivDiv}>
            <Text style={style.loginHeading}>RESET PASSWORD</Text>
          </View>
        </View>
        {/*  */}
